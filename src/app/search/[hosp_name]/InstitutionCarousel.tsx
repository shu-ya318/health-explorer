...
const InstitutionCarousel: React.FC<InstitutionCarouselProps> = ({
  ...
  return (
    <section className="w-full">
      <h3 className="xs:institutionPage-title-xs institutionPage-title-mobile my-[10px]">
        您可能也想比較...
      </h3>
            ...
            >
              ...
              >
                ...
                <div className="w-full max-w-[700px] flex flex-col justify-between p-[15px]">
                  <div className="xl:w-[380px] sm:w-[300px] xs:w-[180px]  w-[400px] pr-[15px] common-card text-[16px] text-[#3E3A39] font-bold">
                    {institution.hosp_name}
                  </div>
                  <div className="xl:w-[380px] sm:w-[300px] xs:w-[180px] w-[400px] common-card text-[14px] text-[#595959]">
