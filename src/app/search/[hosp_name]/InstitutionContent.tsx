    ...
    return(
        <>
            { institutionDetails ? (
                                                        ...
                                                        >
                                                            <Image 
                                                                ...
                                                                className={`rounded-full p-[2px] mt-[20px] 
                                                                            ${isFavorited || favoriteHover[institutionDetails.hosp_name] ?'bg-[#FFFFFF]  common-border border shadow-[0_0_3px_#2D759E]':'border-none shadow-none bg-[#0000004d]'}`} 
                                                            />
                                                        </button>
                                                    );
                                                })()}
                                                    ...
                                                    {displayedInstitutions.map(institution => (   
                                                        ...
                                                        >
                                                            <button 
                                                                ...
                                                                type="button"
                                                                className="flex xs:flex-row flex-col h-full w-full"
                                                            >
                ...
                <div 
                    className="common-row-flex justify-center h-screen" 
