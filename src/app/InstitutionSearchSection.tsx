...
const searches: Search[] = [
  {
    ...
    icon: "/images/building-solid.svg",
  },
  {
    description: "依科別",
    filter: "家庭醫學科",
    image: "/images/division.jpg",
    icon: "/images/stethoscope-solid.svg",
  },
  {
    description: "依癌篩項目",
    filter: "子宮頸癌",
  ...
  },
  {
    ...
    icon: "/images/hospital-regular.svg",
  },
];

const InstitutionSearchSection: React.FC<InstitutionSearchSectionProps> = ({
  handleSearchClick,
}) => {
  const router = useRouter();

  return (
    <section className="w-full common-row-flex justify-center">
      <div
        data-aos="fade-up"
      ...
      >
        <div className="mb-[30px] common-title xs:text-[32px] text-[28px]">
          醫療機構搜尋分類
        </div>
        <section className="grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 xl:gap-36 lg:gap-20 md:gap-x-52 sm:gap-y-8 sm:gap-x-32 gap-y-10 gap-x-0">
