        ...
        <div className="flex sm:flex-row  common-col-flex justify-between items-start max-w-[1200px] w-full lg:w-[90%] md:w-[80%] p-[15px] mx-auto">
          <div className="common-row-flex justify-center my-auto sm:mr-10 mr-4 text-xl transition-all duration-300 hover:scale-110">
            <Link 
              ...
              >
                  <Image src="/images/LOGO.png" alt="Logo" width={46} height={46} className="relative z-0 w-[46px] h-[46px] sm:mr-2 mr-4 object-cover"/>
          ...
          <div className="flex flex-col justify-start items-start my-auto py-[20px] ml-[50px] sm:ml-0 transition-all duration-300">
            ...
            <div className="flex flex-col justify-start sm:items-start my-auto ml-[10px] sm:ml-0 py-[10px]">
                <Link href='https://github.com/shu-ya318/health-explorer' target="_blank" className="mb-2.5 sm:mr-7 text-white no-underline transition-colors cursor-pointer flex items-center shrink-0 hover:text-[#acb8b6] transition-all duration-300 hover:scale-105">
                    <Image src="/images/github.svg"   alt="GitHub" width={28} height={28} className="w-[28px] h-[28px] mr-2.5" />
                    GitHub
                </Link>
                <Link href='https://www.linkedin.com/public-profile/settings?trk=d_flagship3_profile_self_view_public_profile' target="_blank" className="mb-2.5 sm:mr-7 text-white no-underline  transition-colors cursor-pointer flex items-center shrink-0 hover:text-[#acb8b6] transition-all duration-300 hover:scale-105">
                    <Image src="/images/linkedin.jpg" alt="Linkedin" width={28} height={28} className="w-[28px] h-[28px] mr-2.5" />
                    Linkedin
                </Link>
                <Link href='https://www.cakeresume.com/s--hAKER31rB2GiSmznKiXPwg--/funghi0983524367' target="_blank" className="mb-2.5 sm:mr-7 text-white no-underline  transition-colors cursor-pointer flex items-center shrink-0 hover:text-[#acb8b6] transition-all duration-300 hover:scale-105">
                    <Image src="/images/cake.png" alt="Cake" width={28} height={28} className="w-[28px] h-[28px] mr-2.5  rounded-3xl" />
                    Cake
                </Link>
            </div>
        </div>
