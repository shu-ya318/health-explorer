    ...
    return options.map((option, index) => (
      ...
      >
        <label className="common-row-flex py-[10px]">
          ...
          />
          <h5
            className={`text-[18px] font-bold my-auto 
                        ${
                            selectedOption === index + 1
                            ? "text-white"
                            : "text-gray-500"
        ...
        <div className="xl:w-full max-w-[1180px] lg:w-[90%] w-[80%] common-col-flex h-[870px] my-[150px] mb-[40px] mt-[100px] bg-[#FFFFFF] common-border border-2 rounded-lg shadow-[0_0_5px_#AABBCC] text-black">
          ...
          <section className="md:w-[90%] xs:w-[85%] w-[78%] h-[40px] common-row-flex justify-between my-[20px]">
            <div className="flex w-full bg-[#E9ECEf] rounded-lg">
              ...
              >
                <div className="pl-[10px] text-[18px] text-center text-white font-bold">
                  {Math.round(progress)}%
                </div>
                <Image
                  src="/images/pen.png"
          ...
          <section className="w-full common-col-flex justify-center mx-auto mb-[20px] md:px-[60px] px-0 text-[#1D445D]">
            <h2 className="md:w-full w-[80%] mb-[25px] mt-[10px] lg:text-2xl sm:text-[22px] text-[18px] text-center font-bold">
              {title}
            </h2>
            {id === "1" && (
              <input
                ...
                className="lg:w-[20%] md:w-[38%] xs:w-[45%] w-[55%] min-w-[157px] h-[35px] mt-[50px] mb-[75px] px-[10px] border-2 common-border rounded-lg"
                value={inputYear}
