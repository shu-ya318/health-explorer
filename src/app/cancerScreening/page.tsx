...
const surveyItems: SurveyItem[] = [
  ...
  { id: "3", title: "3.您的性別?", itemOptions: ["女性", "男性"] },
  {
    id: "4",
    title: "4.您是否有嚼檳榔的習慣?",
    itemOptions: ["目前已戒掉", "有", "無"],
  },
  {
    id: "5",
    title: "5.您是否有抽菸的習慣?",
    itemOptions: ["1天抽20支以上", "1天最多抽10幾支", "無"],
  },
  {
    id: "6",
    title: "6.您是否有肺癌家族史(父母、子女、兄弟姊妹曾罹患肺癌)?",
    itemOptions: ["有", "無"],
  },
  {
    id: "7",
    title: "7.您是否有乳癌家族史(父母、子女、兄弟姊妹曾罹患乳癌)?",
    itemOptions: ["有", "無"],
  },
];
...
const CancerScreeningPage: React.FC = () => {
  ...
  const handleFinishClick = async (): Promise<void> => {
    if (isLast && !finished && answers.length === surveyItems.length) {
      //  先檢查是最後一題且已作答完畢
